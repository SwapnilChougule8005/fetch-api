...
const RestauranCart = (props) => {
    return (
        <div className="res-cart">
            <img className="res-logo" alt="food logo" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_600/FOOD_CATALOG/IMAGES/CMS/2024/4/12/f7436c8f-4ea1-4bc8-9d66-0fda778d24bf_646af2ce-8728-4ede-9588-20ba52d020ba.jpg"/>
        <h3>{props.resName}</h3>
        <h4>{props.cuisine}</h4>
        <h4>4.4 stars</h4>
        <h4>35 minutes</h4>
    ...
    return (
        <div className="body">
            ...
            <div className="res-conatainer">
             <RestauranCart 
             resName="Meghana Foods" cuisine="biryani, north indian food, Asian"/>
             <RestauranCart resName="KFC" cuisine="burger, fast food"/>
             <RestauranCart/>
             <RestauranCart/>
             <RestauranCart/>
            </div>
